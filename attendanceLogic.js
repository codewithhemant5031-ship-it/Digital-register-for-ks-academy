...
// Assuming absent_students is already defined somewhere
// async function take() {
//     let stus = absent_students.join(", ");
//     console.log(stus);
//     return stus;
// }

// async function sendNotify(messageBody) {
//     const accountSid = 'AC81a478310fce817bcd25f41f58463f2b';
//     const authToken = '110eb917dee42f63cdd6b23ecb683079';
//     const twilioPhoneNumber = '+15673131535';
//     const toPhoneNumber = '+919214242778';
...
//     try {
//         let abs_n = await take();
//         console.log(abs_n);
//         console.log(typeof abs_n);

//         let trial = String(abs_n);
//         console.log(typeof trial);

//         await sendNotify(`The absent students in class X-C are ${trial}, Thanks!`);
//     } catch (error) {
